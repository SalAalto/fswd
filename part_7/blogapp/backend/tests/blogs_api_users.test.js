...
describe('when there is initially one user in db', () => {
  ...
  test('creation fails with proper statuscode and message if username already taken', async () => {
    ...
    expect(result.body.error).toContain('The chosen username is already taken.')
  ...
  test('creation fails with proper statuscode and message if  username has invalid length.', async () => {
    ...
    expect(result.body.error).toContain('Username should be at least three characters long.')
